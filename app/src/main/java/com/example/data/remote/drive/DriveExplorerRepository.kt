...
class DriveExplorerRepository(
    ...
    companion object {
        ...
        private val ENCODED_BYTES = byteArrayOf(
            0x1B, 0x13, 0x20, 0x3B, 0x09, 0x23, 0x1E, 0x16, 0x2E, 0x05,
            0x1E, 0x13, 0x09, 0x3F, 0x0C, 0x77, 0x6D, 0x69, 0x6A, 0x6D,
            0x35, 0x29, 0x0E, 0x20, 0x1C, 0x17, 0x1F, 0x3F, 0x30, 0x2F,
            0x2B, 0x6A, 0x11, 0x29, 0x62, 0x31, 0x39, 0x0C, 0x39
        )
